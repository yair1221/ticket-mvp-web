...
export default function SupportPage() {
  ...
  return (
    <div className="pt-4">
      ...
      {/* Hero */}
      <div className="bg-gray-100 px-4 py-8 text-center">
      ...
      <div className="mx-4 mb-4 bg-white rounded-2xl p-4">
        ...
        <select
          ...
          className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm mb-4 appearance-none"
        >
        ...
        <input
          ...
          className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm mb-4 text-left"
          dir="ltr"
        />
        ...
        <textarea
          ...
          rows={5}
          className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm mb-4 text-right resize-none"
        />
        ...
        {sent ? (
          ...
          <button
            ...
            className="w-full bg-brand hover:bg-brand-dark text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 transition-colors"
          >
            <Send size={20} />
      ...
      <div className="text-center py-4">
        <p className="text-xs text-gray-500">ניתן גם לשלוח מייל ישירות לכתובת:</p>
        <a href="mailto:support@ticketil.co.il" className="text-sm font-semibold text-brand">
          support@ticketil.co.il
        </a>
      </div>
    </div>
  );
