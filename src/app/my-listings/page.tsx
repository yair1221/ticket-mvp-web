  ...
  if (!user) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] px-8">
        ...
        <p className="text-sm text-gray-500 text-center mt-2">עליך להתחבר כדי לצפות בכרטיסים שלך</p>
        <button
        ...
        <div className="p-4 space-y-3">
          {listings.length === 0 ? (
            <div className="flex flex-col items-center py-12">
              ...
              <p className="text-sm text-gray-500 mt-2">אין כרטיסים עדיין</p>
              <button
            ...
            listings.map((listing) => (
              <div key={listing.id} className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                ...
                {/* Seat grid */}
                <div className="flex bg-gray-50 rounded-xl p-3">
                  {listing.section && (
                    <>
                      <div className="flex-1 text-center">
                        <p className="text-[10px] text-gray-400">יציע</p>
                  ...
                  {listing.row_number && (
                    <>
                      <div className="flex-1 text-center">
                        <p className="text-[10px] text-gray-400">שורה</p>
                  ...
                  {listing.seat_number && (
                    <>
                      <div className="flex-1 text-center">
                        <p className="text-[10px] text-gray-400">כיסא</p>
                ...
                {listing.status === 'active' && (
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-1 py-2.5 bg-gray-100 text-gray-600 rounded-xl text-xs font-medium"
                    >
                      <Trash2 size={16} />
                      <span>הסר</span>
                    </button>
